using Common.Helper.JsonConverter;
...
namespace Common.Helper
{
    public class JsonHelper
    {
        ...
        static JsonHelper()
        {
            ...
            objectToJsonOptions.Converters.Add(new Helper.JsonConverter.DateTimeConverter());
            objectToJsonOptions.Converters.Add(new Helper.JsonConverter.DateTimeOffsetConverter());
            objectToJsonOptions.Converters.Add(new LongConverter());
            objectToJsonOptions.Converters.Add(new Helper.JsonConverter.StringConverter());
            ...
            jsonToObjectOptions.Converters.Add(new Helper.JsonConverter.DateTimeConverter());
            jsonToObjectOptions.Converters.Add(new Helper.JsonConverter.DateTimeOffsetConverter());
            jsonToObjectOptions.Converters.Add(new LongConverter());
            jsonToObjectOptions.Converters.Add(new Helper.JsonConverter.StringConverter());
